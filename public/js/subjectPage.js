$(function () {
    ...
    var subjectArray = [{
        subjectContainer: '医生说，被小怪兽袭击的村民会出现咳嗽、低烧、夜间出汗、午后发热、胸痛、疲乏无力、体重减轻、呼吸困难等症状，请问这个小怪兽的真名是（__）',
        optionA: 'A.流感病毒',
        optionB: 'B.结核杆菌',
        optionC: 'C.HIV',
        optionD: 'D.大肠杆菌',
        ...
        subjectContainer: '《西游记》第六七回：“﹝老者﹞用藜杖指定道：‘你这厮，骨挝脸，磕额头，塌鼻子，凹颉腮，毛眼毛睛，痨病鬼，不知高低，尖着个嘴，敢来冲撞我老人家！’” 请问“痨病”在现代被称为（__）',
        optionA: 'A.结核病',
        optionB: 'B.疟疾',
        optionC: 'C.艾滋病',
        optionD: 'D.禽流感',
        ...
        subjectContainer: '你的朋友小明不小心感染了肺结核，你应该劝他（__）',
        ...
        subjectContainer: '你的朋友小明不小心感染了肺结核，此时治疗难度（__）？   他没有坚持治疗，从而出现耐药结核，此时治疗周期（__）？',
        optionA: 'A.高，短',
        optionB: 'B.高，长',
        optionC: 'C.低，长',
        optionD: 'D.低，短',
        ...
        subjectContainer: '你的朋友小明偷偷告诉你他被查出结核病，同一个班的你应该（__）',
        ...
        subjectContainer: '以下哪项对预防结核病有用（__）',
        optionA: 'A.勤洗手、多通风',
        optionB: 'B.正确佩戴口罩',
        optionC: 'C.锻炼身体',
        optionD: 'D.以上均是',
        ...
        subjectContainer: '以下哪项不是结核感染的高危人群（__）',
        optionA: 'A.艾滋病病毒感染者',
        optionB: 'B.免疫力低下者',
        optionC: 'C.老年人和儿童 ',
        optionD: 'D.以上均是高危人群',
        ...
        subjectContainer: '你的朋友小明被查出患有结核病，你觉得他的患病器官一定位于（__）',
